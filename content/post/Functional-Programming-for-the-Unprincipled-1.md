...
## The Purity Ring
At this point I am sure many of my readers are shaking their heads, and perhaps their fists at me. Many hard core proponents of FP will be objecting that my explanation here does not describe _real_ FP. In fact, as noted earlier, I have been told as much. After all, when describing the ideal programming paradigm, I noted we want to use mathematics because it is precise, as opposed to the vague heuristics of OOP. And my description above which shows FP to be “fun, productive and relatively easy to do” leaves out a clear explanation of this most important advantage!
